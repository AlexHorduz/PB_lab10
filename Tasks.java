...
public class Tasks {
	public static void main(String[] args) {
		Actor willSmith = new Actor("Will Smith", new ArrayList<String>(Arrays.asList("Bad Boys", "Men in Black",
																				      "Six Degrees of Separation",
																				      "Showtime", "Jersey Girl")));
		Actor tommy = new Actor("Tommy Lee Jones", new ArrayList<String>(Arrays.asList("Love Story", "Men in Black",
				 																	   "Man of the House",
				 																	   "The Family")));
		Actor me = new Actor("Alex Horduz", new ArrayList<String>());
		Film jerseyGirl = new Film("Jersey Girl", new ArrayList<String>(Arrays.asList("Ben Affleck", "Liv Tyler",
																					  ...
																					  "Matthew Maher")));
		Film sleuth = new Film("Sleuth", new ArrayList<String>(Arrays.asList("Laurence Olivier", "Michael Caine",
	...
	private static boolean Task1() {
		ArrayList<Actor> actors = Films_DB.getActors();
	...
	private static ArrayList<String> Task2(Actor actor) {
		if (actor == null)
			throw new NullPointerException("NULL passed as a parameter");
		ArrayList<String> actorsToReturn = new ArrayList<String>();
		ArrayList<Film> allFilms = Films_DB.getFilms();
		ArrayList<String> actorsFilms = actor.getFilms();
		...
		ArrayList<Actor> allActors = Films_DB.getActors();
	...
	private static String Task3() throws Exception {
		...
		String theBiggestFilm = allFilms.get(0).getName();
		int maxActors = allFilms.get(0).getActors().size();
